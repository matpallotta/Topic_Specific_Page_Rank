...
normalization_factor = int(user_preference_vector[0]) + int(user_preference_vector[2]) + int(user_preference_vector[4]) \
                       + int(user_preference_vector[6]) + int(user_preference_vector[8])
