...
for movie_id in dic_movie_page_rank_one.keys():
    ...
    dic_recomendations[movie_id] += user_preference_vector[0] * dic_movie_page_rank_one[movie_id]
    dic_recomendations[movie_id] += user_preference_vector[2] * dic_movie_page_rank_two[movie_id]
    dic_recomendations[movie_id] += user_preference_vector[4] * dic_movie_page_rank_three[movie_id]
    dic_recomendations[movie_id] += user_preference_vector[6] * dic_movie_page_rank_four[movie_id]
    dic_recomendations[movie_id] += user_preference_vector[8] * dic_movie_page_rank_five[movie_id]

sorted_final_movie_pr_rec = sorted(dic_recomendations, key=lambda x: x[1], reverse=True)
